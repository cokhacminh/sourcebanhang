...
<!-- Vendor -->
		...
		<script src="<?php echo $site_url;?>/assets/vendor/bootstrap-confirmation/bootstrap-confirmation.js"></script>
		...
		<script src="<?php echo $site_url;?>/assets/javascripts/ui-elements/examples.modals.js"></script>
