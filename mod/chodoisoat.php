...
<section class="panel">
	...
	<h2 class="panel-title">DANH SÁCH ĐƠN HÀNG CHỜ ĐỐI SOÁT</h2>
	</header>
	...
	<table class="table table-bordered table-striped mb-none" id="table_donhang">
		<thead>
			<tr>
				...
				<th style="min-width: 100px;text-align: center">Tiền Đối Soát</th>
...
$danhsachdonhang = danhsachdonhang_chodoisoat($dauthang,$cuoithang);
?>
		</tbody>
	</table>
<script>
...
$todate = $_POST['todate'];
$danhsachdonhang = danhsachdonhang_chodoisoat($fromdate,$todate);
	?>
