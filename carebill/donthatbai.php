...
<div class="col-sm-2 form-group">
	...
	<a onclick="donthatbaithangtruoc()" style="font-size: 17px;" class="btn btn-sm btn-danger">XEM THÁNG TRƯỚC</a>
</div>
</form>
</div>
<br /><br />
<hr />
								...
								<table class="table table-bordered table-striped mb-none" id="table_donhang">
									...
									<tbody id="list_products">
										...
										$thangnay = date("Y-m");
										$today = date("Y-m-d");
										$sql = mysql_query("select * from donhang where ( thoigian between '{$thangnay}-01 00:00:00' and '{$today} 23:59:59' ) and status_id in (-1,7,9,11,21,127,49,99) and carebill='{$id_nhanvien}'");
...
<hr />
								...
								<table class="table table-bordered table-striped mb-none" id="table_donhang">
									...
									<tbody id="list_products">
										...
										$sql = mysql_query("select * from donhang where ( thoigian between '{$fromdate} 00:00:00' and '{$todate} 23:59:59' ) and status_id in (-1,7,9,11,21,127,49,99) and carebill='{$id_nhanvien}'");
										while($do = mysql_fetch_array($sql))
										{
											$id = $do['id'];
											$madonhang = $do['madonhang'];
