...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">DANH SÁCH ĐƠN HÀNG ĐANG GIAO </h2>
							</header>
...
<hr />
								...
								<table class="table table-bordered table-striped mb-none" id="table_donhang">
									...
									<tbody id="list_products">
										...
										$thangnay = date("Y-m");
										$today = date("Y-m-d");
										$sql = mysql_query("select * from donhang where ( thoigian between '{$thangnay}-01 00:00:00' and '{$today} 23:59:59' ) and status_id not in (5,6,9,11,99,-1) and carebill='{$id_nhanvien}'");
...
<hr />
								...
								<table class="table table-bordered table-striped mb-none" id="table_donhang">
									...
									<tbody id="list_products">
										...
										$sql = mysql_query("select * from donhang where ( thoigian between '{$fromdate} 00:00:00' and '{$todate} 23:59:59' ) and status_id not in (5,6,9,11,99,-1) and carebill='{$id_nhanvien}'");
