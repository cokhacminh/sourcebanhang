...
<section class="panel">
	...
	<h2 class="panel-title">DANH SÁCH YÊU CẦU XỬ LÝ ĐƠN HÀNG</h2>
	</header>
...
<div class="col-md-12" style="font-size: 13px;color:black;" id="bangdulieu" >
	<table class="table table-bordered table-striped mb-none" id="table_donhang">
		<thead>
			<tr>
				<th style="text-align: center">ThờiGian</th>
...
$danhsachdonhang = danhsachticket($dauthang,$cuoithang);
?>
		</tbody>
	</table>
<script>
...
$todate = $_POST['todate'];
$danhsachdonhang = danhsachticket($fromdate,$todate);
	?>
