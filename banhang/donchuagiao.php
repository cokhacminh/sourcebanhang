	...
	<table class="table table-bordered table-striped mb-none" id="table_donhang">
		<thead>
			<tr>
				...
				<th style="min-width: 100px;text-align: center">Page</th>
...
$danhsachdonhang = danhsachdonhang_danggiao($dauthang,$cuoithang);
?>
		</tbody>
	</table>
<script>
...
$todate = $_POST['todate'];
$danhsachdonhang = danhsachdonhang_danggiao($fromdate,$todate);
	?>
