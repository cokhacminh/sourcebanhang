...
<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">DANH SÁCH ĐƠN VỊ GIAO HÀNG</h2>
							</header>
							<div class="panel-body" style="font-size: 18px;">
								<div class="row">
									<div class="col-sm-12">
										<div class="mb-md col-sm-6">
<a style="font-size: 17px;" class="modal-with-form btn btn-sm btn-primary" href="#modalForm_themdvgh">Thêm Đơn Vị Giao Hàng <i class="fa fa- truck"></i></a>
										</div>										
									</div>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody id="list_dvgh">
										...
										<?php
										$sql = mysql_query("select * from donvigiaohang");
	...
	<a href=\"{$site_url}/images/logo/{$hinhanh}\" data-plugin-lightbox data-plugin-options='{ \"type\":\"image\" }' title=\"{$tendvgh} \n{$ghichu}\">
												<img class=\"img-responsive listdvgh hvr-grow\" src=\"{$site_url}/images/logo/{$hinhanh}\">
											</a>
											</td>
											<td style=\"vertical-align: middle;text-align:center\">{$tendvgh}</td>
