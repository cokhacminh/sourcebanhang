								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										while($do = mysql_fetch_array($sql))
										{
											...
											$groupid = $do['groupid'];
											$data_group = getDataWhere("ten","usergroup","id",$groupid);
											$nhom = $data_group['ten'];
											$id = $do['id'];
											...
											<td style=\"vertical-align: middle;text-align:center\"><a href=\"#modalForm_edituser\" class=\"hvr-float modal-with-form mb-xs mt-xs mr-xs btn btn-success\" onclick=\"suataikhoan({$id})\"><i class=\"fa fa-pencil-square-o\"></i> CHỈNH SỬA</a> <a class=\"mb-xs mt-xs mr-xs btn btn-danger\" title=\"Xóa tài khoản này\" onclick=\"xoataikhoan({$id})\"><i class=\"fa fa-user-times\"></i> XÓA</a></td>
										</tr>
											";
											...
											<div class="panel-body">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
																...
																<?php
																	$sql_checkbox = mysql_query("select * from usergroup where id!=1");
																	while($data_checkbox = mysql_fetch_array($sql_checkbox))
																	{
																		echo "<div class=\"radio-custom\" style=\"display:inline\">
