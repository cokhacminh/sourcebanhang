								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										while($do = mysql_fetch_array($sql))
										{
											...
											$groupid = $do['groupid'];
											$data_group = getDataWhere("ten,quanlynhanvien","usergroup","id",$groupid);
											$chucvu = $data_group['ten'];
										...
										<section class="panel">
											...
											<div class="panel-body">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select data-plugin-selectTwo class="form-control populate" name="chucvu">
																<?php
