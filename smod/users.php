...
<section class="panel">
							...
							<div class="panel-body" style="font-size: 16px;">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a class="modal-with-form btn btn-primary" href="#modalForm_adduser">Thêm Nhân Viên <i class="fa fa-user-plus"></i></a>
										</div>
									</div>
								</div>
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										while($do = mysql_fetch_array($sql))
										{
											...
											if($group['quanlynhanvien'] =="0")
											$button2 = "<a class=\"hvr-float modal-with-form mb-xs mt-xs mr-xs btn btn-danger\" onclick=\"xoataikhoan({$id})\"><i class=\"fa fa-trash-o\"></i> XÓA</a>";
											else $button2 = "";
											$button = "<a href=\"#modalForm_edituser\" class=\"hvr-float modal-with-form mb-xs mt-xs mr-xs btn btn-success\" onclick=\"suataikhoan({$id})\"><i class=\"fa fa-pencil-square-o\"></i> CHỈNH SỬA</a>";
											echo "
											<tr class=\"gradeX\">
											...
											<td style=\"vertical-align: middle;text-align:center\">{$button}{$button2}</td>
										</tr>
											";
										...
										<section class="panel">
											...
											<div class="panel-body">
													...
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select class="form-control populate" name="chucvu">
												<?php
												$sql = mysql_query("select * from usergroup where id!='1' and quanlynhanvien ='0'");
...
$("form#add_user").submit(function(){
    ...
    $.ajax({
        url: '../ajax/users.php?dosomething=add_user',
        type: 'POST',
        data: formData,
        async: false,
...
$("form#form_edituser").submit(function(){
    ...
    $.ajax({
        url: '../ajax/users.php?dosomething=edit_user',
        type: 'POST',
        data: formData,
        async: false,
        success: function (data) {
