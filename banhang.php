		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<div class="row">
						<div id="loadingdiv" class="col-md-12" style="z-index: 999;height: 500px;text-align: center;background: #DDDDDD91;position: absolute;display: none">
						...
						<div class="col-lg-12" id="form_donhang">
							...
							<section class="panel panel-primary">
								...
								<div class="panel-body" id="thongtindonhang">
