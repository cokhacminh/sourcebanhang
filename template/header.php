<!-- Mobile Metas -->
		...
		<link rel="stylesheet" href="<?php echo $site_url;?>/assets/vendor/hover-css/hover.css" />
		<!-- Sweetalert -->
		<script src="<?php echo $site_url;?>//assets/javascripts/sweetalert/sweetalert2.min.js"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo $site_url;?>//assets/javascripts/sweetalert/sweetalert2.min.css">
